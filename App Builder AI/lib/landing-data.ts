...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    features: [
      "Free daily usage",
      "Create anything from slides to apps",
      "Built-in database",
  ...
  },
  {
    id: "core",
    name: "Core",
    description: "Daily agent credits",
    monthlyPrice: 25,
    yearlyPrice: 18,
    originalPrice: 20,
    ...
    accent: "orange",
    icon: "sparkle",
    badges: ["AI integrations"],
    featuresIntro: "Everything in Starter plus:",
    features: [
      "More free agent usage",
      "$20 towards most powerful models",
      "Plan mode",
  ...
  },
  {
    id: "pro",
    name: "Pro",
    description: "10 parallel agents",
    monthlyPrice: 25,
    yearlyPrice: 23,
    originalPrice: 25,
    ...
    accent: "blue",
    icon: "rocket",
    badges: ["10 parallel agents", "Premium Support"],
    featuresIntro: "Everything in Core plus:",
    features: [
      "Even more free agent usage",
      "$100 towards most powerful models",
      "Up to 15 collaborators",
      "Invite up to 50 viewers",
      "Database rollback up to 28 days",
    ],
  },
  {
    id: "enterprise",
    ...
    accent: "none",
    featuresIntro: "Enterprise-grade security and control",
    features: [
      "Custom seat limits",
      "SSO / SAML",
