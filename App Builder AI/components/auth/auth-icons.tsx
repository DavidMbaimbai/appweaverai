  ...
  return (
    <svg
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.98 8.223A10.477 10.477 0 0 0 2.25 12s3.75 7.5 9.75 7.5c1.708 0 3.257-.41 4.606-1.06M6.228 6.228A10.451 10.451 0 0 1 12 4.5c6 0 9.75 7.5 9.75 7.5a10.523 10.523 0 0 1-4.293 4.925M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.243L9.88 9.88"
      />
    </svg>
  );
}
